...
const BIO_QUESTIONS_DATA					= {
	...
	3: {
		...
		dimensions: {
			...
			bianshi: '<strong>变式题</strong>：下图是叶绿体内光合作用的两阶段物质流：<div class="svg-figure"><svg viewBox="0 0 400 280" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;max-width:420px;display:block;margin:0 auto;"><rect x="0" y="0" width="400" height="280" fill="#FFFFFF"/><text x="200" y="20" text-anchor="middle" font-size="12" font-weight="700" fill="#1A1A1A">叶绿体内的光合作用</text><ellipse cx="200" cy="155" rx="170" ry="105" fill="#F0F9F0" stroke="#22C55E" stroke-width="2"/><text x="200" y="260" text-anchor="middle" font-size="10" fill="#166534" font-weight="600">叶绿体</text><rect x="70" y="60" width="130" height="70" rx="8" fill="#22C55E" opacity="0.85"/><text x="135" y="80" text-anchor="middle" font-size="11" fill="white" font-weight="700">类囊体薄膜</text><text x="135" y="95" text-anchor="middle" font-size="9" fill="white">（光反应）</text><text x="135" y="115" text-anchor="middle" font-size="9" fill="white">H₂O → O₂ + ATP + NADPH</text><rect x="220" y="60" width="130" height="70" rx="8" fill="#8B6914" opacity="0.85"/><text x="285" y="80" text-anchor="middle" font-size="11" fill="white" font-weight="700">基质</text><text x="285" y="95" text-anchor="middle" font-size="9" fill="white">（暗反应）</text><text x="285" y="115" text-anchor="middle" font-size="9" fill="white">CO₂ + C₅ → 2×C₃ → G3P</text><path d="M 200 85 L 220 85" stroke="#C94A4A" stroke-width="2.5" marker-end="url(#arrR)"/><text x="210" y="80" text-anchor="middle" font-size="9" fill="#C94A4A" font-weight="700">ATP/NADPH</text><path d="M 220 105 L 200 105" stroke="#1E40AF" stroke-width="2.5" marker-end="url(#arrL)"/><text x="210" y="120" text-anchor="middle" font-size="9" fill="#1E40AF" font-weight="700">ADP/NADP⁺</text><path d="M 40 95 L 70 95" stroke="#F59E0B" stroke-width="2" marker-end="url(#arrR)"/><text x="35" y="99" text-anchor="end" font-size="10" fill="#F59E0B" font-weight="600">光 ☀</text><path d="M 40 75 L 70 75" stroke="#3B82F6" stroke-width="2" marker-end="url(#arrR)"/><text x="35" y="79" text-anchor="end" font-size="10" fill="#3B82F6" font-weight="600">H₂O</text><path d="M 200 75 L 170 50" stroke="#22C55E" stroke-width="2" marker-end="url(#arrR2)"/><text x="160" y="48" text-anchor="end" font-size="10" fill="#22C55E" font-weight="600">O₂ ↑</text><path d="M 350 95 L 380 95" stroke="#8B6914" stroke-width="2" marker-end="url(#arrR)"/><text x="385" y="99" text-anchor="start" font-size="10" fill="#8B6914" font-weight="700">葡萄糖</text><path d="M 360 75 L 335 75" stroke="#3B82F6" stroke-width="2" marker-end="url(#arrL)"/><text x="365" y="79" text-anchor="start" font-size="10" fill="#3B82F6" font-weight="600">CO₂</text><rect x="80" y="190" width="240" height="50" fill="#FDF8F0" stroke="#C9A96E" stroke-width="1" rx="6"/><text x="200" y="208" text-anchor="middle" font-size="10" font-weight="700" fill="#8B6914">关键：光反应与暗反应场所不同</text><text x="200" y="222" text-anchor="middle" font-size="9" fill="#5A5A5A">光反应在<tspan fill="#22C55E" font-weight="700">类囊体</tspan>，暗反应在<tspan fill="#8B6914" font-weight="700">基质</tspan></text><text x="200" y="235" text-anchor="middle" font-size="9" fill="#5A5A5A">两者靠 ATP/NADPH 联动</text><defs><marker id="arrR" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#C94A4A"/></marker><marker id="arrL" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#1E40AF"/></marker><marker id="arrR2" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#22C55E"/></marker></defs></svg><div class="svg-caption">图：光反应与暗反应在叶绿体内的分工与协同</div></div><strong>问</strong>：突然停止光照，哪些物质浓度会在 30 秒内快速变化？<br><br><strong style="color:#8B6914;">参考答案</strong>：C<sub>3</sub> 上升（没 NADPH/ATP 还原它）；C<sub>5</sub> 下降（没有 C<sub>3</sub> 还原产物再生）；ATP/NADPH 下降（光反应停）；O<sub>2</sub> 骤降。',
	...
	6: {
		...
		dimensions: {
			...
			bianshi: '<strong>变式题</strong>：某渔场鱼类 K 值为 10000，当前数量 8000。<div class="svg-figure"><svg viewBox="0 0 400 270" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;max-width:420px;display:block;margin:0 auto;"><rect x="0" y="0" width="400" height="270" fill="#FFFFFF"/><text x="200" y="20" text-anchor="middle" font-size="12" font-weight="700" fill="#1A1A1A">种群 S 型增长曲线</text><line x1="60" y1="40" x2="60" y2="220" stroke="#1A1A1A" stroke-width="1.5"/><line x1="60" y1="220" x2="370" y2="220" stroke="#1A1A1A" stroke-width="1.5"/><text x="60" y="35" text-anchor="middle" font-size="10" fill="#1A1A1A">种群数量</text><text x="385" y="225" text-anchor="middle" font-size="10" fill="#1A1A1A">时间</text><line x1="55" y1="60" x2="360" y2="60" stroke="#C94A4A" stroke-width="1" stroke-dasharray="4,3"/><text x="365" y="64" text-anchor="start" font-size="10" fill="#C94A4A" font-weight="700">K = 10000</text><line x1="55" y1="140" x2="360" y2="140" stroke="#F59E0B" stroke-width="1" stroke-dasharray="4,3"/><text x="365" y="144" text-anchor="start" font-size="10" fill="#F59E0B" font-weight="700">K/2 = 5000</text><path d="M 60 215 Q 120 210, 160 180 T 220 140 Q 280 80, 360 65" stroke="#22C55E" stroke-width="3" fill="none"/><circle cx="220" cy="140" r="5" fill="#F59E0B"/><text x="225" y="155" font-size="9" fill="#F59E0B" font-weight="700">K/2（增长最快）</text><circle cx="290" cy="90" r="5" fill="#8B6914"/><text x="295" y="85" font-size="9" fill="#8B6914" font-weight="700">当前 8000</text><rect x="80" y="175" width="130" height="35" fill="#F0F9F0" stroke="#22C55E" stroke-width="1" rx="4"/><text x="145" y="190" text-anchor="middle" font-size="9" fill="#166534" font-weight="700">最大可持续产量</text><text x="145" y="202" text-anchor="middle" font-size="9" fill="#166534">维持在 K/2</text><text x="60" y="238" text-anchor="middle" font-size="9" fill="#5A5A5A">0</text><text x="370" y="238" text-anchor="middle" font-size="9" fill="#5A5A5A">t</text></svg><div class="svg-caption">图：S 型曲线中 K/2 是增长速率最大点（渔业捕捞黄金点）</div></div><strong>问</strong>：① 此时增长速率如何？② 要获得最大可持续产量，应把种群维持在什么数量？<br><br><strong style="color:#8B6914;">参考答案</strong>：① 当前 8000 已超过 K/2（5000），增长速率<strong>正在下降</strong>，接近 0<br>② 维持在 <strong>K/2 = 5000</strong> 时可持续捕捞，每次捕到让种群回到 K/2 时增长最快<br><strong>启示</strong>：过度捕捞不是"多捕鱼"，而是"破坏增长点"。',
	...
	7: {
		...
		dimensions: {
			...
			bianshi: '<strong>变式题</strong>：下图是缩手反射弧：<div class="svg-figure"><svg viewBox="0 0 400 290" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;max-width:420px;display:block;margin:0 auto;"><rect x="0" y="0" width="400" height="290" fill="#FFFFFF"/><text x="200" y="20" text-anchor="middle" font-size="12" font-weight="700" fill="#1A1A1A">缩手反射弧 · 快速路 vs 慢速路</text><text x="45" y="75" text-anchor="middle" font-size="16">&#x1F525;</text><text x="45" y="95" text-anchor="middle" font-size="9" fill="#C94A4A" font-weight="600">热刺激</text><ellipse cx="110" cy="80" rx="30" ry="18" fill="#FDE8E8" stroke="#C94A4A" stroke-width="1.5"/><text x="110" y="78" text-anchor="middle" font-size="9" font-weight="700" fill="#C94A4A">感受器</text><text x="110" y="90" text-anchor="middle" font-size="8" fill="#C94A4A">皮肤</text><rect x="190" y="60" width="60" height="40" rx="6" fill="#FDF8F0" stroke="#8B6914" stroke-width="1.5"/><text x="220" y="78" text-anchor="middle" font-size="9" font-weight="700" fill="#8B6914">脊髓</text><text x="220" y="90" text-anchor="middle" font-size="8" fill="#8B6914">中枢</text><ellipse cx="340" cy="80" rx="35" ry="18" fill="#FEF3C7" stroke="#D97706" stroke-width="1.5"/><text x="340" y="78" text-anchor="middle" font-size="9" font-weight="700" fill="#D97706">肌肉</text><text x="340" y="90" text-anchor="middle" font-size="8" fill="#D97706">效应器</text><path d="M 140 80 L 190 80" stroke="#C94A4A" stroke-width="2" marker-end="url(#arrRed)"/><text x="165" y="70" text-anchor="middle" font-size="8" fill="#C94A4A">传入</text><path d="M 250 80 L 305 80" stroke="#D97706" stroke-width="2" marker-end="url(#arrOrange)"/><text x="277" y="70" text-anchor="middle" font-size="8" fill="#D97706">传出</text><rect x="60" y="115" width="280" height="25" fill="#F0F9F0" stroke="#22C55E" stroke-width="1.5" rx="4"/><text x="200" y="131" text-anchor="middle" font-size="10" font-weight="700" fill="#166534">&#x26A1; 快速路（脊髓）：缩手 &lt; 50 ms</text><ellipse cx="340" cy="200" rx="50" ry="22" fill="#E0E7FF" stroke="#1E40AF" stroke-width="1.5"/><text x="340" y="200" text-anchor="middle" font-size="10" font-weight="700" fill="#1E40AF">大脑皮层</text><text x="340" y="213" text-anchor="middle" font-size="8" fill="#1E40AF">（痛觉中心）</text><path d="M 220 100 Q 270 150, 295 185" stroke="#1E40AF" stroke-width="1.5" stroke-dasharray="4,3" fill="none" marker-end="url(#arrBlue)"/><text x="245" y="150" font-size="8" fill="#1E40AF">上行</text><rect x="60" y="230" width="280" height="25" fill="#E0E7FF" stroke="#1E40AF" stroke-width="1.5" rx="4"/><text x="200" y="246" text-anchor="middle" font-size="10" font-weight="700" fill="#1E40AF">&#x23F1; 慢速路（大脑）：痛觉 &gt; 100 ms</text><text x="200" y="275" text-anchor="middle" font-size="10" fill="#C94A4A" font-weight="700">结果：先缩手，后感觉疼</text><defs><marker id="arrRed" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#C94A4A"/></marker><marker id="arrOrange" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#D97706"/></marker><marker id="arrBlue" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#1E40AF"/></marker></defs></svg><div class="svg-caption">图：反射弧的"快速路（脊髓）"与"慢速路（大脑）"</div></div><strong>问</strong>：为什么说"缩手先于痛觉"？这种设计的生理意义是什么？<br><br><strong style="color:#8B6914;">参考答案</strong>：缩手只需经过脊髓（短回路，毫秒级），痛觉要经过大脑皮层（长回路，更慢）。<strong>生理意义</strong>：让身体在"意识到疼"之前就避开伤害，这是进化优化的<strong>保护机制</strong>。',
	...
	9: {
		...
		dimensions: {
			...
			bianshi: '<strong>变式题</strong>：下图是 BR 与生长素单独/共同作用下植物伸长的实验结果：<div class="svg-figure"><svg viewBox="0 0 400 270" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;max-width:420px;display:block;margin:0 auto;"><rect x="0" y="0" width="400" height="270" fill="#FFFFFF"/><text x="200" y="20" text-anchor="middle" font-size="12" font-weight="700" fill="#1A1A1A">植物激素浓度-伸长效应曲线</text><line x1="60" y1="40" x2="60" y2="220" stroke="#1A1A1A" stroke-width="1.5"/><line x1="60" y1="220" x2="370" y2="220" stroke="#1A1A1A" stroke-width="1.5"/><text x="60" y="35" text-anchor="middle" font-size="10" fill="#1A1A1A">下胚轴伸长 (mm)</text><text x="385" y="225" text-anchor="middle" font-size="9" fill="#1A1A1A">浓度 (nM)</text><text x="60" y="238" text-anchor="middle" font-size="9" fill="#5A5A5A">0.01</text><text x="135" y="238" text-anchor="middle" font-size="9" fill="#5A5A5A">0.1</text><text x="210" y="238" text-anchor="middle" font-size="9" fill="#5A5A5A">1</text><text x="285" y="238" text-anchor="middle" font-size="9" fill="#5A5A5A">10</text><text x="360" y="238" text-anchor="middle" font-size="9" fill="#5A5A5A">100</text><path d="M 60 200 Q 135 170, 210 100 Q 285 110, 360 180" stroke="#8B6914" stroke-width="2.5" fill="none"/><circle cx="210" cy="100" r="5" fill="#C94A4A"/><text x="220" y="95" font-size="9" fill="#C94A4A" font-weight="700">最适浓度 ≈ 1 nM</text><path d="M 60 210 Q 135 195, 210 150 Q 285 170, 360 210" stroke="#3B82F6" stroke-width="2" stroke-dasharray="4,3" fill="none"/><text x="80" y="205" font-size="9" fill="#8B6914" font-weight="700">─ BR</text><text x="80" y="218" font-size="9" fill="#3B82F6" font-weight="700">⋯ 生长素</text><rect x="220" y="50" width="150" height="40" fill="#FDF8F0" stroke="#C9A96E" stroke-width="1" rx="4"/><text x="295" y="65" text-anchor="middle" font-size="9" font-weight="700" fill="#8B6914">两重性</text><text x="295" y="78" text-anchor="middle" font-size="8" fill="#5A5A5A">低浓度促进</text><text x="295" y="88" text-anchor="middle" font-size="8" fill="#5A5A5A">高浓度抑制</text></svg><div class="svg-caption">图：BR 与生长素均呈现"两重性"，但受体和通路独立</div></div><strong>问</strong>：这说明什么？如何设计实验验证两者作用机制的差异？<br><br><strong style="color:#8B6914;">参考答案</strong>：说明 BR 和生长素<strong>有独立作用</strong>，但协同工作时效果更好（可能激活不同信号通路互补）。<strong>验证方法</strong>：用受体突变体——单独敲除生长素受体或 BR 受体，看是否仍能响应另一激素。如果能，说明两者受体独立。',
	...
	10: {
		...
		dimensions: {
			...
			bianshi: '<strong>变式题</strong>：下图为 DNA 半保留复制前三代的结果：<div class="svg-figure"><svg viewBox="0 0 400 290" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;max-width:420px;display:block;margin:0 auto;"><rect x="0" y="0" width="400" height="290" fill="#FFFFFF"/><text x="200" y="20" text-anchor="middle" font-size="12" font-weight="700" fill="#1A1A1A">DNA 半保留复制（Meselson-Stahl 实验）</text><text x="50" y="55" font-size="10" font-weight="700" fill="#5A5A5A">亲代：</text><rect x="170" y="45" width="60" height="10" fill="#C94A4A"/><rect x="170" y="56" width="60" height="10" fill="#C94A4A"/><text x="235" y="62" font-size="9" fill="#C94A4A" font-weight="700">¹⁵N/¹⁵N（重带）</text><text x="50" y="95" font-size="10" font-weight="700" fill="#5A5A5A">第 1 代：</text><rect x="130" y="85" width="60" height="10" fill="#C94A4A"/><rect x="130" y="96" width="60" height="10" fill="#F59E0B"/><rect x="210" y="85" width="60" height="10" fill="#F59E0B"/><rect x="210" y="96" width="60" height="10" fill="#C94A4A"/><text x="290" y="103" font-size="9" fill="#F59E0B" font-weight="700">2 条中带</text><text x="50" y="155" font-size="10" font-weight="700" fill="#5A5A5A">第 2 代：</text><rect x="100" y="135" width="40" height="8" fill="#C94A4A"/><rect x="100" y="144" width="40" height="8" fill="#F59E0B"/><rect x="150" y="135" width="40" height="8" fill="#22C55E"/><rect x="150" y="144" width="40" height="8" fill="#F59E0B"/><rect x="200" y="135" width="40" height="8" fill="#22C55E"/><rect x="200" y="144" width="40" height="8" fill="#F59E0B"/><rect x="250" y="135" width="40" height="8" fill="#C94A4A"/><rect x="250" y="144" width="40" height="8" fill="#F59E0B"/><text x="105" y="165" font-size="8" fill="#F59E0B">中</text><text x="155" y="165" font-size="8" fill="#22C55E">轻</text><text x="205" y="165" font-size="8" fill="#22C55E">轻</text><text x="255" y="165" font-size="8" fill="#F59E0B">中</text><text x="320" y="145" font-size="9" fill="#22C55E" font-weight="700">2 轻 + 2 中</text><rect x="60" y="190" width="320" height="75" fill="#FDF8F0" stroke="#C9A96E" stroke-width="1" rx="6"/><text x="220" y="208" text-anchor="middle" font-size="11" font-weight="700" fill="#8B6914">规律（n 次复制后）</text><text x="75" y="225" font-size="10" fill="#1A1A1A">&bull; 重带（¹⁵N/¹⁵N）= <tspan fill="#C94A4A" font-weight="700">0</tspan>（从第 2 代起）</text><text x="75" y="240" font-size="10" fill="#1A1A1A">&bull; 中带（¹⁵N/¹⁴N）= <tspan fill="#F59E0B" font-weight="700">2</tspan>（永远不变）</text><text x="75" y="255" font-size="10" fill="#1A1A1A">&bull; 轻带（¹⁴N/¹⁴N）= <tspan fill="#22C55E" font-weight="700">2ⁿ − 2</tspan></text><rect x="40" y="275" width="10" height="8" fill="#C94A4A"/><text x="55" y="282" font-size="8" fill="#5A5A5A">¹⁵N</text><rect x="95" y="275" width="10" height="8" fill="#F59E0B"/><text x="110" y="282" font-size="8" fill="#5A5A5A">¹⁵N/¹⁴N 混</text><rect x="175" y="275" width="10" height="8" fill="#22C55E"/><text x="190" y="282" font-size="8" fill="#5A5A5A">¹⁴N</text></svg><div class="svg-caption">图：半保留复制下重带消失，中带永远 2 条，轻带指数增加</div></div><strong>问</strong>：经过 <strong>4 次复制</strong>后，轻带和中带的比例是多少？<br><br><strong style="color:#8B6914;">参考答案</strong>：<br>&bull; 总 DNA 数 = 2<sup>4</sup> = 16<br>&bull; 中带 = 2（始终是最初的 2 条 <sup>15</sup>N 链和新配的 <sup>14</sup>N 链）<br>&bull; 轻带 = 16 − 2 = <strong>14</strong><br>&bull; 比例 <strong>轻带 : 中带 = 7 : 1</strong><br>&bull; 规律：<strong>中带永远 = 2，轻带 = 2<sup>n</sup> − 2</strong>',
	...
	16: {
		...
		dimensions: {
			...
			bianshi: '<strong>变式题</strong>：某发酵罐中培养酵母菌生产啤酒：<div class="svg-figure"><svg viewBox="0 0 400 280" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;max-width:420px;display:block;margin:0 auto;"><rect x="0" y="0" width="400" height="280" fill="#FFFFFF"/><text x="200" y="20" text-anchor="middle" font-size="12" font-weight="700" fill="#1A1A1A">酵母菌发酵实验装置</text><text x="100" y="48" text-anchor="middle" font-size="11" font-weight="700" fill="#22C55E">① 前期：有氧阶段</text><rect x="40" y="60" width="120" height="100" fill="#F0F9F0" stroke="#22C55E" stroke-width="2" rx="8"/><path d="M 40 90 Q 100 100, 160 85" stroke="#22C55E" stroke-width="1" fill="none" stroke-dasharray="2,2"/><circle cx="60" cy="120" r="3" fill="#8B6914"/><circle cx="85" cy="110" r="3" fill="#8B6914"/><circle cx="110" cy="130" r="3" fill="#8B6914"/><circle cx="135" cy="115" r="3" fill="#8B6914"/><circle cx="80" cy="140" r="3" fill="#8B6914"/><circle cx="120" cy="145" r="3" fill="#8B6914"/><text x="100" y="175" text-anchor="middle" font-size="9" fill="#166534" font-weight="700">酵母菌液 + 葡萄糖</text><path d="M 100 50 L 100 60" stroke="#3B82F6" stroke-width="2" marker-end="url(#arrB)"/><text x="115" y="55" font-size="9" fill="#3B82F6" font-weight="700">O₂（通气）</text><path d="M 100 60 L 100 50" stroke="#C94A4A" stroke-width="2" stroke-dasharray="2,2"/><text x="115" y="45" font-size="9" fill="#C94A4A" font-weight="700">CO₂ ↑</text><text x="100" y="195" text-anchor="middle" font-size="9" fill="#166534">酵母<strong>大量繁殖</strong></text><text x="300" y="48" text-anchor="middle" font-size="11" font-weight="700" fill="#8B6914">② 后期：无氧阶段</text><rect x="240" y="60" width="120" height="100" fill="#FDF8F0" stroke="#8B6914" stroke-width="2" rx="8"/><path d="M 240 70 L 360 70" stroke="#8B6914" stroke-width="3"/><text x="300" y="60" text-anchor="middle" font-size="8" fill="#8B6914">密封盖</text><circle cx="260" cy="120" r="3" fill="#8B6914"/><circle cx="285" cy="110" r="3" fill="#8B6914"/><circle cx="310" cy="130" r="3" fill="#8B6914"/><circle cx="335" cy="115" r="3" fill="#8B6914"/><circle cx="280" cy="140" r="3" fill="#8B6914"/><circle cx="320" cy="145" r="3" fill="#8B6914"/><text x="300" y="175" text-anchor="middle" font-size="9" fill="#8B6914" font-weight="700">密闭（缺氧）</text><text x="370" y="115" font-size="9" fill="#C94A4A" font-weight="700">酒精</text><text x="370" y="128" font-size="9" fill="#C94A4A" font-weight="700">+ CO₂</text><path d="M 360 120 L 380 120" stroke="#C94A4A" stroke-width="2" marker-end="url(#arrR3)"/><text x="300" y="195" text-anchor="middle" font-size="9" fill="#8B6914">产<strong>酒精</strong>（啤酒核心）</text><rect x="40" y="215" width="320" height="55" fill="#FDF8F0" stroke="#C9A96E" stroke-width="1" rx="6"/><text x="200" y="233" text-anchor="middle" font-size="10" font-weight="700" fill="#8B6914">关键：酵母菌是兼性厌氧</text><text x="200" y="248" text-anchor="middle" font-size="9" fill="#5A5A5A">有氧 &rarr; 大量繁殖（有氧呼吸产 CO₂ + H₂O）</text><text x="200" y="262" text-anchor="middle" font-size="9" fill="#5A5A5A">无氧 &rarr; 酒精发酵（产酒精 + CO₂）</text><defs><marker id="arrB" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#3B82F6"/></marker><marker id="arrR3" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#C94A4A"/></marker></defs></svg><div class="svg-caption">图：啤酒酿造的两阶段装置（前期通气繁殖、后期密封发酵）</div></div><strong>问</strong>：① 为什么前期通气后期密闭？② 如果<strong>全程通气</strong>，有酒精吗？<br><br><strong style="color:#8B6914;">参考答案</strong>：<br>① 前期通气让酵母菌<u>有氧呼吸大量繁殖</u>（能量多、细胞分裂快）；后期密闭让酵母菌<u>无氧发酵产酒精</u>（这是啤酒的主要步骤）<br>② 几乎没有酒精——因为有氧条件下酵母菌优先进行有氧呼吸，把葡萄糖完全氧化成 CO<sub>2</sub> 和水，不会走发酵路径（这叫<strong>"巴斯德效应"</strong>）',
	...
	20: {
		...
		dimensions: {
			...
			bianshi: '<strong>变式题</strong>：下图为综合生态农场的物质循环：<div class="svg-figure"><svg viewBox="0 0 400 320" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;max-width:420px;display:block;margin:0 auto;"><rect x="0" y="0" width="400" height="320" fill="#FFFFFF"/><text x="200" y="20" text-anchor="middle" font-size="12" font-weight="700" fill="#1A1A1A">综合生态农场 · 物质循环图</text><circle cx="100" cy="90" r="38" fill="#D1FAE5" stroke="#22C55E" stroke-width="2"/><text x="100" y="85" text-anchor="middle" font-size="11" font-weight="700" fill="#166534">&#x1F33E; 水稻田</text><text x="100" y="100" text-anchor="middle" font-size="8" fill="#166534">光合作用</text><text x="100" y="112" text-anchor="middle" font-size="8" fill="#166534">固定 CO₂</text><circle cx="300" cy="90" r="38" fill="#DBEAFE" stroke="#3B82F6" stroke-width="2"/><text x="300" y="85" text-anchor="middle" font-size="11" font-weight="700" fill="#1E40AF">&#x1F41F; 鱼塘</text><text x="300" y="100" text-anchor="middle" font-size="8" fill="#1E40AF">吃虫+藻</text><text x="300" y="112" text-anchor="middle" font-size="8" fill="#1E40AF">粪便肥田</text><circle cx="300" cy="220" r="38" fill="#FDE68A" stroke="#D97706" stroke-width="2"/><text x="300" y="215" text-anchor="middle" font-size="11" font-weight="700" fill="#D97706">&#x1F437; 养殖场</text><text x="300" y="230" text-anchor="middle" font-size="8" fill="#D97706">畜禽饲养</text><text x="300" y="242" text-anchor="middle" font-size="8" fill="#D97706">+ 粪便</text><circle cx="100" cy="220" r="42" fill="#F3E8FF" stroke="#8B5CF6" stroke-width="2"/><text x="100" y="215" text-anchor="middle" font-size="11" font-weight="700" fill="#6D28D9">&#x1F525; 沼气池</text><text x="100" y="230" text-anchor="middle" font-size="8" fill="#6D28D9">厌氧分解</text><text x="100" y="242" text-anchor="middle" font-size="8" fill="#6D28D9">产甲烷+沼液</text><path d="M 138 90 L 262 90" stroke="#22C55E" stroke-width="2" marker-end="url(#arrG)"/><text x="200" y="84" text-anchor="middle" font-size="8" fill="#166534" font-weight="600">秸秆/藻类</text><path d="M 300 128 L 300 182" stroke="#D97706" stroke-width="2" marker-end="url(#arrO)"/><text x="305" y="158" font-size="8" fill="#D97706" font-weight="600">饲料</text><path d="M 262 220 L 142 220" stroke="#8B5CF6" stroke-width="2" marker-end="url(#arrP)"/><text x="200" y="214" text-anchor="middle" font-size="8" fill="#6D28D9" font-weight="600">粪便</text><path d="M 100 182 L 100 128" stroke="#22C55E" stroke-width="2" marker-end="url(#arrG)"/><text x="55" y="158" font-size="8" fill="#166534" font-weight="600">沼液</text><text x="55" y="170" font-size="8" fill="#166534" font-weight="600">（肥料）</text><path d="M 120 180 L 280 130" stroke="#3B82F6" stroke-width="1" stroke-dasharray="3,3" fill="none"/><path d="M 280 180 L 120 130" stroke="#3B82F6" stroke-width="1" stroke-dasharray="3,3" fill="none"/><rect x="160" y="270" width="80" height="35" fill="#FEE2E2" stroke="#C94A4A" stroke-width="1.5" rx="6"/><text x="200" y="287" text-anchor="middle" font-size="10" font-weight="700" fill="#C94A4A">&#x1F4A1; 沼气</text><text x="200" y="299" text-anchor="middle" font-size="8" fill="#C94A4A">替代煤电</text><path d="M 100 262 Q 130 278, 160 285" stroke="#C94A4A" stroke-width="1.5" fill="none" marker-end="url(#arrR4)"/><text x="15" y="302" font-size="7" fill="#5A5A5A" font-style="italic">&bull; 绿箭=物质流</text><text x="125" y="302" font-size="7" fill="#5A5A5A" font-style="italic">&bull; 蓝虚线=能量联系</text><text x="270" y="302" font-size="7" fill="#5A5A5A" font-style="italic">&bull; 沼气→双碳目标</text><defs><marker id="arrG" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#22C55E"/></marker><marker id="arrO" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#D97706"/></marker><marker id="arrP" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#8B5CF6"/></marker><marker id="arrR4" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><polygon points="0 0, 6 3, 0 6" fill="#C94A4A"/></marker></defs></svg><div class="svg-caption">图：四大模块互相供料互为终端，实现物质闭环</div></div><strong>问</strong>：如果上述生态农场要<strong>扩大规模</strong>到整个乡镇，会遇到什么新问题？该如何规划？<br><br><strong style="color:#8B6914;">参考答案</strong>：<br><strong>新问题</strong>：<br>① <strong>物流与能量损耗</strong>——规模大了，沼气输送、肥料运输损耗增加<br>② <strong>病虫害传染风险</strong>——单一化种植易爆发病害<br>③ <strong>管理复杂度</strong>——需要专业团队+数据化管理<br>④ <strong>市场波动</strong>——产品多样化反而可能库存积压<br><br><strong>规划建议</strong>：<br>① <strong>分区经营</strong>——不同农户负责不同环节，形成互补网络<br>② <strong>物联网 + AI</strong>——实时监控各环节数据<br>③ <strong>政府支持</strong>——低息贷款 + 技术培训 + 销售渠道<br>④ <strong>保险机制</strong>——应对气候/病害风险<br>⑤ <strong>品牌化</strong>——打"生态+有机"高端品牌',
